        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          <div>
            <img 
              ...
              alt="Luxe Aesthetic Lab Founder" 
          ...
          <div>
            ...
            <p className="text-stone-600 leading-relaxed mb-4 font-light">
              Luxe Aesthetic Lab is a boutique skincare studio specializing in advanced, personalized facial treatments. 
              We are not a traditional spa; we are a results-oriented aesthetic lab.
            </p>
            <p className="text-stone-600 leading-relaxed mb-4 font-light">
              We focus on skin revision for concerns such as acne, reactive pigmentation, and age management. 
              With professional-grade techniques, state-of-the-art modalities, and a deep understanding of skin physiology, 
              we guide our clients toward lasting skin health.
            </p>
            <p className="text-stone-600 leading-relaxed mb-8 font-light">
              Led by Sophia, our skilled esthetician with over a decade of experience, we craft customized skincare 
