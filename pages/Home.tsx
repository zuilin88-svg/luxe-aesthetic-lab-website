    ...
    <main>
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1600334089648-b0d9c3024ea2?auto=format&fit=crop&q=80&w=1920"
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto fade-in mt-16">
          <p className="text-white/90 font-sans uppercase tracking-[0.2em] text-sm md:text-base mb-6 drop-shadow-sm">
            Advanced Clinical Skincare
          </p>
          <h1 className="text-white font-serif text-5xl md:text-7xl lg:text-8xl leading-tight mb-8 drop-shadow-lg">
            Luxe Aesthetic Lab
          </h1>
          <p className="text-stone-100 font-sans text-lg md:text-xl font-light mb-12 max-w-2xl mx-auto drop-shadow-md">
            Your Journey, Your Skin, Our Expertise. Experience the ultimate in personalized care.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/services" 
              className="px-8 py-3 bg-white text-stone-900 font-sans uppercase tracking-widest text-sm hover:bg-gold-500 hover:text-white transition-colors duration-300 shadow-lg"
            >
              View Services
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white rounded-xl shadow-xl overflow-hidden min-h-[400px]">
            ...
            <div className="lg:col-span-8 p-8 lg:p-16 flex flex-col justify-center h-full relative">
               ...
               <div className="animate-fade-in transition-opacity duration-500 ease-in-out" key={activeReviewIndex}>
